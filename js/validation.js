...
function validar(input) {
    ...
    if (input.validity.valid){
        ...
        input.parentElement.querySelector(".contacto__formulario--message").innerHTML = "";
    } else {
        input.classList.add("formulario__input--invalid");
        input.parentElement.querySelector(".contacto__formulario--message").innerHTML = mostrarMensajeDeError(tipoDeInput, input);
    }
}
